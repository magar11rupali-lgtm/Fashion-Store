        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-lg border shadow-sm p-6 mb-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg mt-4">
              <p className="text-sm text-blue-900">
                ...
                {order.attributes.paymentMethod === 'cod' && 'Cash on Delivery'}
                {order.attributes.paymentMethod === 'card' && 'Credit/Debit Card'}
                {order.attributes.paymentMethod === 'paypal' && 'PayPal'}
              </p>
              {order.attributes.paymentMethod === 'cod' && (
          ...
          <div className="bg-white rounded-lg border shadow-sm p-6 mb-6">
            ...
            <div className="text-gray-700">
              ...
              <p>{order.attributes.customer.address}</p>
              <p>
                {order.attributes.customer.city},{' '}
                {order.attributes.customer.postalCode}
              </p>
              <p>{order.attributes.customer.country}</p>
              <p className="mt-2">📞 {order.attributes.customer.phone}</p>
              <p>📧 {order.attributes.customer.email}</p>
            </div>
          </div>
