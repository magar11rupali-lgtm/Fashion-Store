    ...
    <footer className="bg-gray-800 text-white mt-16">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Fashion Store</h3>
            <p className="text-gray-400 text-sm sm:text-base mb-4">
              Your one-stop shop for trendy fashion. Quality products, great prices, and exceptional service.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/shipping" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">
                  Shipping & Returns
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/profile" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">
                  My Account
                </Link>
              </li>
              <li>
                <Link href="/orders" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">
                  Order History
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <form onSubmit={handleNewsletterSubmit} className="mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 px-3 sm:px-4 py-2 rounded-lg sm:rounded-l-lg sm:rounded-r-none text-gray-800 focus:outline-none text-sm sm:text-base"
                  required
                />
                <button
                  type="submit"
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg sm:rounded-l-none sm:rounded-r-lg transition-colors text-sm sm:text-base touch-manipulation"
                >
                  Subscribe
                </button>
              </div>
            ...
            {/* Social Media Links */}
            <div>
              <p className="text-gray-400 mb-3 text-xs sm:text-sm">Follow us on social media</p>
